...
Widget build(BuildContext context) {
  return GetBuilder<DashboardController>(
    ...
    boxShadow: [
      BoxShadow(
        color: Colors.grey.withOpacity(0.05), // Slight grey shadow with 5% opacity
  ...
  lineHeight: 8.0,
  percent: 0.5, // Example value
  backgroundColor: Colors.grey[300]!,
  linearGradient: LinearGradient(
    colors: [Color(0xff3DC5A2), Color(0xff3DC5A2), Color(0xffF0C27D),Color(0xff3DC5A2), Color(0xff3DC5A2)],
    stops: [0.0, 0.30, 0.3, 0.6, 0.60], // Adjust the stops for the amber section
  ),
    ...
    boxShadow: [
      BoxShadow(
        ...
        blurRadius: 18.0, // Blur radius of the shadow
            ...
            options: CarouselOptions(height: 300.0, enlargeCenterPage: false),
            items: [
              _buildChartPage(
                'Avg Break Time',
 ...
 List<ChartData> getChartData() {
  ...
  Widget _buildChartPage(String title, List<double> data,String time,String period) {
    return Card(
      elevation: 4,
      color: backgroundColor,
                ...
                series: <CartesianSeries>[
                  LineSeries<ChartData, String>(
                    dataSource: List.generate(
                      data.length,
                      (index) => ChartData('Day ${index + 1}', data[index]),
                    ),
    ...
    return CircularPercentIndicator(
      ...
      center: Column(
        ...
        children: <Widget>[
          Text(
            '${(percent * 10).toInt()}',
            style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold,color: Colors.black), // Adjusted the font size
          ),
          Text(
            leaveType,
            style: TextStyle(fontSize: 12.0,color: Color(0xff3BBCA0)), // Adjusted the font size
          ),
        ],
      ),
