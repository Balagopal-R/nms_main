...
class ApprovalsScreen extends StatelessWidget {
          ...
          body: PagedListView<int, PunchApprovalsModel>(
            ...
            builderDelegate: PagedChildBuilderDelegate<PunchApprovalsModel>(
              ...
              ApprovalsWidget(
                ...
                reqTime: controller.formatEpochToTimeStringIN(item.punchInDatetime),
                // reqWorkMode: item.punchLocation,
                reqWorkMode: item.reasonToChange,
                onCancelTap: () async {
                ...
                viewRequestTap: () async {
                  ...
                  //   ApprovalsBottomSheet(controller: controller),
                  //   isScrollControlled: true,
  ...
  void _showCustomDialog(BuildContext context, ApprovalsController controller, int requestId) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () async {
                await controller.userPunchRequestCancel(requestId);
                Navigator.of(context).pop();
              },
...
//               slivers: [
//                 PagedListView<int, PunchApprovalsModel>(
//                   pagingController: controller.pagingController,
//                   builderDelegate: PagedChildBuilderDelegate<PunchApprovalsModel>(
//                     itemBuilder: (context, item, index) {
//                       return ApprovalsWidget(
